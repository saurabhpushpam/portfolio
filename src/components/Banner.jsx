import bannerImage from "../assets/sp.jpg";
    ...
    >
      ...
      <div className="w-full flex items-center justify-center text-white ">
        ...
        <div className="w-2/3 space-y-2  ms-10">
          ...
          <h1 className="text-5xl font-bold">Saurabh Pushpam</h1>
          <h2 className="text-3xl ">
            I am <span className="font-bold underline" ref={el}></span>
          </h2>
          <p className="">
            a passionate and results-driven Full Stack Developer specializing in React.js and Node.js. With a keen eye for detail and a knack for solving complex problems, I bring a unique blend of technical expertise and creative thinking to every project.
          </p>
